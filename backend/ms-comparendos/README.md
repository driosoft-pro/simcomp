...
Secretos requeridos:
- `/run/secrets/comparendos_db_password` (para `COMPARENDOS_DB_PASSWORD`)
- `/run/secrets/jwt_secret` (para `JWT_SECRET`)

> [!CAUTION]
> Si estas variables no están definidas en el entorno or en los secretos, el servicio no iniciará para proteger la integridad del sistema.
